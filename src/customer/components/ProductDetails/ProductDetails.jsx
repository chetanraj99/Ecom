		...
		<div className="bg-white">
			<div className="pt-6">
					...
					<div className="lg:col-span-1 maxt-auto max-w-2xl  px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
						...
						<div className="mt-4 lg:row-span-3 lg:mt-0">
							...
							<div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
								...
								<p className="opacity-50 lign-through">
				...
				<section className="px-4 ">
					...
					<div className=" p-5">
						<Grid container spacing={7} className="flex md:flex-row flex-col  ">
							<Grid item>
				...
				{/* similar products */}
				<section className="">
					<h1 className="px-4 mb-5 text-center md:text-start">
						Similar Products
					</h1>
					<div className="grid p-2 r  justify-items-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2">
						{mens_kurta.map((item) => (
